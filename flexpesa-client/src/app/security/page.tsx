    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <Header
          ...
          subtitle="Bank-grade security protecting your financial data"
        />
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">Security Certifications & Compliance</h2>
        ...
        {/* Security Practices */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-8">Security Practices & Procedures</h2>
        ...
        {/* Threat Protection */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-8">Threat Protection Matrix</h2>
        ...
        {/* Incident Response */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-8">Incident Response Process</h2>
        ...
        <div className="bg-gradient-to-r from-gray-50 to-blue-50 border border-blue-200 rounded-lg p-8 mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Responsible Disclosure & Bug Bounty</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Bug Bounty Program</h3>
              <p className="text-gray-600 mb-4">
